...
--
-- Host: localhost    Database: hr_platform
-- ------------------------------------------------------
...
CREATE TABLE `contracts` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_name` int unsigned DEFAULT NULL,
...
CREATE TABLE `follow_im_test` (
  ...
  `im_test_id` bigint unsigned NOT NULL,
  `profil_id` int unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `file1` int DEFAULT NULL,
  `file2` int DEFAULT NULL,
  `file3` int DEFAULT NULL,
  `im_test_templates_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `hr_job_categories_sections` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `hr_job_category_id` int unsigned NOT NULL,
...
CREATE TABLE `hr_job_standards_job_categories` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `job_standard_id` int unsigned NOT NULL,
...
CREATE TABLE `hr_tor` (
  ...
  `immap_office_id` bigint unsigned DEFAULT NULL,
  ...
  `duration_id` bigint unsigned DEFAULT NULL,
  `job_standard_id` int unsigned NOT NULL,
  `job_category_id` int unsigned NOT NULL,
...
CREATE TABLE `hr_tor_requirements` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tor_id` int unsigned DEFAULT NULL,
  `requirement` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `component` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `requirement_value` json NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `hr_tor_sections` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `hr_tor_id` bigint unsigned NOT NULL,
  `sub_section` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sub_section_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `level` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `im_test` (
  ...
  `text2` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `text3` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `file_dataset1` int DEFAULT NULL,
  `file_dataset2` int DEFAULT NULL,
  `file_dataset3` int DEFAULT NULL,
  ...
  `im_test_templates_id` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `im_test_answer` (
  ...
  `profil_id` int unsigned NOT NULL,
  `im_test_id` bigint unsigned NOT NULL,
  `question_im_test_id` bigint unsigned NOT NULL,
  `multiple_choice_im_test_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `im_test_templates` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `limit_time_hour` int unsigned NOT NULL,
  `limit_time_minutes` int unsigned NOT NULL,
  `is_default` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `jobs` (
  ...
  `contract_length` int unsigned NOT NULL,
  `tor_id` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `multiple_choice_im_test` (
  ...
  `question_im_test_id` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `p11_education_schools` (
  ...
  `profile_id` int unsigned NOT NULL,
  `country_id` int unsigned NOT NULL,
  `certificate_file_id` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `p11_education_universities` (
  ...
  `profile_id` int unsigned NOT NULL,
  `country_id` int unsigned NOT NULL,
  `diploma_file_id` int unsigned DEFAULT NULL,
  `degree_level_id` int unsigned DEFAULT NULL,
  `untilNow` tinyint NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `p11_employment_records` (
  ...
  `number_of_employees_supervised` int unsigned DEFAULT NULL,
...
CREATE TABLE `p11_employment_records_sectors` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `p11_employment_id` int unsigned NOT NULL,
...
CREATE TABLE `p11_employment_records_skills` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `p11_employment_record_id` int unsigned NOT NULL,
...
CREATE TABLE `p11_field_of_works` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `field_of_work_id` int unsigned NOT NULL,
  `profile_id` int unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `p11_permanent_civil_servants` (
  ...
  `from` date NOT NULL,
  `to` date NOT NULL,
  `is_now` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `p11_portfolios_sectors` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `p11_portfolio_id` int unsigned NOT NULL,
  `sector_id` int unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `p11_professional_society_sector` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `p11_society_id` int unsigned NOT NULL,
  `sector_id` int unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `p11_publications` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `profile_id` int unsigned NOT NULL,
  `publication_file_id` int unsigned DEFAULT NULL,
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `p11_sectors` (
  ...
  `profile_id` int unsigned NOT NULL,
  `sector_id` int unsigned NOT NULL,
  `years` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `p11_skills` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `proficiency` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `profil_assignment_question` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `profil_id` int unsigned NOT NULL,
  `category_question_reference_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `profile_roster_processes` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `roster_process_id` bigint unsigned DEFAULT NULL,
  `profile_id` int unsigned DEFAULT NULL,
  ...
  `im_test_template_id` bigint unsigned DEFAULT NULL,
  ...
  `interview_invitation_done` tinyint(1) NOT NULL DEFAULT '0',
  `reference_check_id` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `profiles` (
  ...
  `id_card_id` int unsigned DEFAULT NULL,
  `passport_id` int unsigned DEFAULT NULL,
  ...
  `work_experience_months` int NOT NULL DEFAULT '0',
  `work_experience_days` int NOT NULL DEFAULT '0',
  `is_immap_inc` tinyint(1) NOT NULL DEFAULT '0',
  `is_immap_france` tinyint(1) NOT NULL DEFAULT '0',
  `job_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `question_im_test` (
  ...
  `im_test_id` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `question_reference` (
  ...
  `category_question_reference_id` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `quiz_template_essay_questions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `quiz_template_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `quiz_template_mc_question_answers` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `quiz_template_mcq_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `roles_immap_offices` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `role_id` int unsigned NOT NULL,
  `immap_office_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_answer_im_test` (
  ...
  `user_id` int unsigned NOT NULL,
  `question_im_test_id` bigint unsigned DEFAULT NULL,
  `multiple_choice_im_test_id` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_answer_question_reference` (
  ...
  `question_reference_id` bigint unsigned DEFAULT NULL,
  `answer` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `p11_references_id` int unsigned DEFAULT NULL,
  `profil_id` int unsigned NOT NULL,
  `category_question_reference_id` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `users` (
  ...
  `family_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `full_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `photo` int unsigned DEFAULT NULL,
...
-- Dump completed on 2020-01-29  9:12:41
